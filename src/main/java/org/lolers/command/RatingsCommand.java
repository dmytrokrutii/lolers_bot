...
public class RatingsCommand implements Command {
    private static final Logger LOGGER = LoggerFactory.getLogger(RatingsCommand.class);
    ...
    @Inject
    public RatingsCommand(Provider<MessageService> provider, RatingService ratingService, UserStorage userStorage) {
    ...
    public void execute(Update update) {
        ...
        msg.append(String.format("%s це потужність, яка складається з %s та %s\n", POWER, LIKE, HEART));
